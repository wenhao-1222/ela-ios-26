...
extension AppKit.NSImage {
    ...
    /// The "hg_image_not_selected" asset catalog image.
    static var hgImageNotSelected: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .hgImageNotSelected)
#else
        .init()
#endif
    }

    /// The "hg_image_selected" asset catalog image.
    static var hgImageSelected: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .hgImageSelected)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "hg_image_not_selected" asset catalog image.
    static var hgImageNotSelected: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .hgImageNotSelected)
#else
        .init()
    ...
    /// The "hg_image_selected" asset catalog image.
    static var hgImageSelected: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .hgImageSelected)
#else
        .init()
