    ...
    var body: some View {
        GeometryReader(content: { geometry in
            VStack {
                ...
                let dataOBj =  entry.isSnap ? WidgetUtils().getNaturalDataArrayDefault(type: .carbo) : WidgetUtils().getNaturalDataArray(type: .carbo)
...
//                        .foregroundColor(Color(UIColor.WIDGET_COLOR_GRAY_BLACK_45))
                ...
                HStack{
                    ElaWeekWidgetBarChartView(number: Int(numbers[0]),percent: numbers[0]/totalNumber,weekDay: (dataArray[0]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[1]),percent: numbers[1]/totalNumber,weekDay: (dataArray[1]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[2]),percent: numbers[2]/totalNumber,weekDay: (dataArray[2]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[3]),percent: numbers[3]/totalNumber,weekDay: (dataArray[3]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[4]),percent: numbers[4]/totalNumber,weekDay: (dataArray[4]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[5]),percent: numbers[5]/totalNumber,weekDay: (dataArray[5]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                    Spacer()
                        .frame(width: spaceWidth,height: barHeight)
                    ElaWeekWidgetBarChartView(number: Int(numbers[6]),percent: numbers[6]/totalNumber,weekDay: (dataArray[6]as? NSDictionary ?? [:]).stringValueForKeyWidget(key: "weekday"),themeColor: Color(UIColor.COLOR_CARBOHYDRATE))
                        .frame(width: barWidth,height: barHeight)
                }
...
//            .background(Color.white.opacity(0.85))
            .onAppear{
//                WidgetUtils().sendNaturalLast7Days(forNaturalType: 11)
            }
        })
    }
}
