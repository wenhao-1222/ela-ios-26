...
class LogsMealsSetAlertVM: UIView {
...
//        whiteView.layer.cornerRadius = whiteViewTopRadius
    ...
    func setPickerViewInitStatus() {
        for i in 0..<mealsArray.count{
            ...
            if meals == "\(UserInfoModel.shared.mealsNumber)"{
...
extension LogsMealsSetAlertVM:UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        lab.text = "\(mealsArray[row]as? String ?? "") 餐"
