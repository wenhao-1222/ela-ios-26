//
//  AppearanceOptionsAlertVM.swift
//  lns
//
//  Created by LNS2 on 2025/11/26.
//


import UIKit

class AppearanceOptionsAlertVM: UIView {
    ...
    lazy var typeArray: [UIUserInterfaceStyle] = {
...
extension AppearanceOptionsAlertVM{
    ...
    func setPickerViewInitStatus() {
        for i in 0..<typeArray.count{
            ...
            if type == UserConfigModel.shared.overrideUserInterfaceStyle{
...
extension AppearanceOptionsAlertVM:UIPickerViewDelegate,UIPickerViewDataSource{
