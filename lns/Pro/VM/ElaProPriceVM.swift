...
//            make.right.equalTo(renewalSwitch.snp.left).offset(kFitWidth(-12))
    ...
    private func configureGuidanceDisplayMode() {
        ...
        configureBenefitRows([
            ...
            FeatureContent(title: "优先体验新功能", desc: "新功能上线时第一时间体验", iconName: "pro_func_new_icon")
        ])
        configureMoreRows([
            FeatureContent(title: "日常饮食记录", iconName: "guidance_pro_fell_icon_1"),
            FeatureContent(title: "身体数据记录", iconName: "guidance_pro_fell_icon_2")
        ])
