...
final class GuidanceGoalPlanMuscleGainModeVM: GuidanceGoalPlanChoicePageVM {
    ...
    init(flowState: GuidanceGoalPlanFlowState) {
        ...
        super.init(
            ...
            options: [
                GuidanceGoalPlanOption(title: "更注重增肌质量", detail: "适合希望在增肌过程中尽可能控制脂肪增长，并维持较低体脂水平的运动员、健身爱好者等", value: "quality"),
                GuidanceGoalPlanOption(title: "平衡增肌质量与速度", detail: "适合希望兼顾肌肉增长速度与脂肪控制，稳步增加肌肉量和身体围度的运动员、健身爱好者等", value: "balanced"),
                GuidanceGoalPlanOption(title: "更注重增肌速度", detail: "适合希望在较短时间内最大化增加体重和肌肉围度的偏瘦人群，通常也会伴随更多脂肪增长", value: "speed")
            ],
