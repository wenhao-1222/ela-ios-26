...
class CourseChangeDeviceVC: WHBaseViewVC {
    ...
    lazy var changeButton: UIButton = {
        ...
        btn.addTarget(self, action: #selector(sendReBindDeviceRequest), for: .touchUpInside)
...
extension CourseChangeDeviceVC{
...
extension CourseChangeDeviceVC{
    ...
    @objc func sendReBindDeviceRequest() {
        MCToast.mc_loading()
