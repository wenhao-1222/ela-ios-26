//
//  ForumDetailVideoControlView.m
//  lns
//
//  Created by Elavatine on 2025/1/6.
//
...
@interface ForumDetailVideoControlView () <ZFSliderViewDelegate>
/// 竖屏控制层的View
...
@implementation ForumDetailVideoControlView
...
//        _portraitControlView.slider.hidden = true;
//        _portraitControlView.playOrPauseBtn.selected = NO;
        [_portraitControlView.player.currentPlayerManager pause];
//        _portraitControlView.topToolView.hidden = YES;
//        _portraitControlView.backBtn.hidden = YES;
//        _portraitControlView.shareVideoBtn.hidden = YES;
//        _portraitControlView.nextBtn.hidden = YES;
...
//        _landScapeControlView.nextBtn.hidden = YES;
//        _landScapeControlView.slider.hidden = YES;
...
- (ZFSliderView *)bottomPgrogress {
    if (!_bottomPgrogress) {
        ...
        _bottomPgrogress.minimumTrackTintColor = [UIColor colorWithRed:0 green:112.0/255.0f blue:1.0f alpha:1.0];//007AFF
