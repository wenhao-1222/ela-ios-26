...
@interface ForumListVideoControlView : UIView<ZFPlayerMediaControl>
...
@property (nonatomic, copy) void(^mutedCallback)(void);
...
@property (nonatomic, strong) UIImageView *mutedImgView;//静音按钮
