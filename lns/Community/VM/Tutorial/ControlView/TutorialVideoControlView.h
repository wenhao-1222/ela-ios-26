...
@interface TutorialVideoControlView : UIView<ZFPlayerMediaControl>

/// 竖屏控制层的View
@property (nonatomic, strong, readonly) TutorialVideoPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) TutorialVideoLandScapeControlView *landScapeControlView;
...
/// 分享
@property (nonatomic, copy) void(^shareBtnClickCallback)(BOOL isPortrait);
...
/// 手动点击时 控制层显示、隐藏动画的时长，默认0.25秒
@property (nonatomic, assign) NSTimeInterval tapFadeTimeInterval;
...
//@property (nonatomic, strong) ForumTutorialModel *tuModel;
@property (nonatomic, assign) CGFloat oldRate; //长按手势快进使用
@property (nonatomic, strong) TutorialVideoRateView *rateView;//选择播放速率
/**
 设置标题、封面、全屏模式
