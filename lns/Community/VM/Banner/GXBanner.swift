...
//        zhView.currentPageTintColor = WHColor_RGB(r: 255, g: 83, b: 107 )
        pageControl.pageIndicatorTintColor = WHColor_RGB(r: 241, g: 181, b: 190 )
        pageControl.currentPageIndicatorTintColor = WHColor_RGB(r: 255, g: 83, b: 107 )
...
//        center.y = self.flowLayout.itemSize.height - self.pageControl.frame.height * 0.5
        center.y = self.bounds.height - self.pageControl.frame.height * 0.5
