...
public final class ELAFlowingGradientBackgroundView: UIView {
    ...
    public struct Style {
        ...
        public static let light = Style(
            ...
            midColor: UIColor(red: 218.0 / 255.0, green: 229.0 / 255.0, blue: 246.0 / 255.0, alpha: 1.0),
            bottomColor: UIColor(red: 248.0 / 255.0, green: 250.0 / 255.0, blue: 253.0 / 255.0, alpha: 1.0),
