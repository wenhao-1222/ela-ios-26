...
extension MCToastConfig {
    public struct Background {
        /// toast 的背景颜色
        public var color: UIColor = UIColor.black.withAlphaComponent(0.88)
        public var colorAlpha: CGFloat = 0.88
    }
    ...
    public struct Text {
        public var textColor: UIColor = UIColor.white
        public var font: UIFont = UIFont.systemFont(ofSize: 14, weight: .medium)//UIFont.systemFont(ofSize: 12)
        /// 圆角
        public var cornerRadius: CGFloat = 4
        /// 内边距（toast和其中的内容的最小边距）
        public var padding: UIEdgeInsets = UIEdgeInsets(top: 10, left: 36, bottom: 10, right: 36)
